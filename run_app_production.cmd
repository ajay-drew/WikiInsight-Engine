...
if exist "venv\Scripts\activate.bat" (
    start "API" cmd /k "cd /d %~dp0 && call venv\Scripts\activate.bat && uvicorn src.api.main:app --host 127.0.0.1 --port %API_PORT%"
) else if exist ".venv\Scripts\activate.bat" (
    start "API" cmd /k "cd /d %~dp0 && call .venv\Scripts\activate.bat && uvicorn src.api.main:app --host 127.0.0.1 --port %API_PORT%"
) else (
    start "API" cmd /k "cd /d %~dp0 && uvicorn src.api.main:app --host 127.0.0.1 --port %API_PORT%"
)
